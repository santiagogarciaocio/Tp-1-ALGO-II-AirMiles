...
\In usuarioReferidor: Usuario
    ...
    \aseguraLargo{  
        ...
        igualesSalvoUsuarioIdaVuelta(AM_0.historialesTransacciones, am.historialesTransacciones,\seq{usuarioReferidor}) \land \\  
        |AM_0.historialesTransacciones|+1 = |am.historialesTransacciones| \land \\        
        am.historialesVuelos = añadirUsuario(AM_0.historialesVuelos,usuario) \land \\
        igualesSalvoUsuarioIdaVuelta(AM_0.historialesVuelos, am.historialesVuelos, \seq{usuarioReferidor}) \land \\
...
\In promocion: NombrePromocion
    ...
    \aseguraLargo{am.promociones = AM_0.promociones \land \\
        ...
        am.historialesTransacciones[usuario] = agregarElemento(AM_0.historialesTransacciones,$\seq{\tupla{"Acumular",millasVuelo(distancia,categoria,facto)}}$ \land \\
